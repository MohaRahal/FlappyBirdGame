...
font = pygame.font.Font('fonts/FlappyBirdRegular-9Pq0.ttf', 100)
white = (255,255,255)
...
class Button():
    ...
    def draw(self):
        ...
        pos = pygame.mouse.get_pos()
         #verificar se o mouse esta em cima do botao
...
while run:
    ...
    if pygame.sprite.groupcollide(bird_group,pipe_group,False,False) or flappy.rect.top <= 100:
        game_over = True
    ...
    #verifica game over e desenha o botao
    if game_over == True:
        if button.draw() == True:
            game_over = False
            score = reset_game()
